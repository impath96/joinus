...
<script type="text/javascript">
	...
	IMP.request_pay({
		...
		if(rsp.success){ //결제성공시
			$.ajax({ //결제검증
                ...
                location.href="${PageContext.request.contextPath }/rental/partnerPlaceList?type=0&location=0";
            }
		});
	});
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            ...
            <div class="row g-4 text-center justify py-5 shadow m-md-5" id="remove" style="background-color: #F6F7F8; border-radius: 50px;">
                    	<h2 class="sub2 " style="color:  #63cf8e;"> &#9888; 결제중 &#9888;  </h2>
                    	<h3 class="club_content">결제 진행중 입니다!</h3>
                    	<h3 class="club_content">성공적으로 결제후 페이지 이동합니다 </h3>
            </div>
